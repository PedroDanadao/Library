...
var new_book_button = document.querySelector(".new_book_button");
var new_book_form = document.querySelector(".book_form");
var warn_removal_checkbox = document.querySelector("#warn_removal_checkbox");
...
function remove_book_from_library(m_event) {
    if (warn_removal_checkbox.checked) {
        var delete_confirmed = confirm("Do you Really want to remove this book?");
        if (!delete_confirmed) {
            return;
        }
    }
...
function add_100_books() {
    /**
     * Function to help me check the page with a lot of books in it. I can just comment the last line
     * of the script or not.
     */
