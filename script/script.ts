...
const warn_removal_checkbox = document.querySelector("#warn_removal_checkbox") as HTMLInputElement;
...
function remove_book_from_library(m_event: MouseEvent) {
    if (warn_removal_checkbox.checked) {
        const delete_confirmed = confirm("Do you Really want to remove this book?");
